...
import com.googleapp.newsapp.NewsApplicationApp
...
class NewsViewModel(
    ...
    fun getBreakingNews(countryCode : String) = viewModelScope.launch {
        safeBreakingNewsCall(countryCode)
         //when we post value then our fragment will notify
    }
    ...
    private fun hasInternetConnection() : Boolean {
        val connectivityManager = getApplication<NewsApplicationApp>().getSystemService( //check if user has connection to internet
